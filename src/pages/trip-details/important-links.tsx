...
export const ImportantLinks = () => {
    return (
        ...
        <div className='space-y-5'>
            <div className='flex justify-between items-center gap-4'>
                <div className='space-y-1.5 '>
                    ...
                    <a href='' className='block text-xs text-zinc-100 truncate hover:text-zinc-200'>
                        https://www.airbnb.com.br/rooms/1047sdsdsdsds0001
                    </a>
                </div>
        ...
        <div className='space-y-5'>
            <div className='flex justify-between items-center gap-4'>
                <div className='space-y-1.5 '>
                    <span className='block font-medium text-zinc-100'>Regra de casa</span>
                    <a href='' className='block text-xs text-zinc-100 truncate hover:text-zinc-200'>
